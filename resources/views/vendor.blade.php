          ...
          <div class="card-body">
            <div style="width: 100%; display:flex; flex-direction: row; align-items:center">
                ...
                <div class="search-bar" style="margin-left:20%;">
                    <form class="search-form d-flex align-items-center" method="POST" action="{{ route('vendor-search') }}">
                        @csrf
                      <input type="varchar" name="vendor" placeholder="Search" title="Enter search keyword">
